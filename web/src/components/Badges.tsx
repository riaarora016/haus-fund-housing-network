...
export const HouseChip = ({ h }: { h: string }) => <span className={`chip mr-0.5 ${h === 'punk-house' ? 'border-sky-300 text-sky-800 dark:text-sky-300' : h === 'femme-house' ? 'border-pink-300 text-pink-800 dark:text-pink-300' : 'border-teal-300 text-teal-800 dark:text-teal-300'}`}>{h}</span>;
